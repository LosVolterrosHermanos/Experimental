...
"""Initializers - Minimal version for MaxText Lite."""
...
from .common_types import Array, DType, Shape, PRNGKey
...
def variable_to_logically_partitioned(variable):
  """Simplified partitioning for basic use."""
  return variable