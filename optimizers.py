...
def adana_optimizer(
    ...
    *,
    ...
    def init_fn(params):
        ...
        return AdanaOptimizerState(count=jnp.zeros([], jnp.int32), m=m, v=v, tau=tau)
    ...
    def update_fn(updates, state, params=None):
        ...
        return updates, AdanaOptimizerState(count=count_inc, m=new_m, v=new_v, tau=new_tau)
