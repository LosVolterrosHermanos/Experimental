...
do
    ...
    tanea_g2=$(echo "scale=6; $((RANDOM % 1000 + 1000)) / 10000000" | bc)
    tanea_g3=$(echo "scale=7; $((RANDOM % 2000 + 2000)) / 100000000" | bc)
    tanea_kappa=$(echo "scale=2; $((RANDOM % 20 + 65)) / 100" | bc)
    weight_decay_ts=$(echo "scale=0; $((RANDOM % 200 + 100))" | bc)
