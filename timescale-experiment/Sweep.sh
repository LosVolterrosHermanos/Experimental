...
do
    ...
    python nanogpt_tanea_tau_stats.py --train_steps=30000 --batch_size=8 --val_batch_size=1 --val_steps=128 --seq_len=1024 --tanea_g2=$tanea_g2 --tanea_g3=$tanea_g3 --tanea_kappa=$tanea_kappa --weight_decay=1E-3 --power_weight_decay=1.0 --weight_decay_ts=$weight_decay_ts
done
